...
public class NettyServer implements TransportServer {
    ...
    public void start(RequestHandlerRegistry requestHandlerRegistry, int port) throws Exception {
        ...
        ServerBootstrap serverBootstrap = newBootstrap(channelHandlerPipeline, acceptEventGroup, ioEventGroup); //netty事件循环和请求handler
        Channel channel = doBind(serverBootstrap); //绑定端口,启动监听
